...
โครงสร้าง Web App สำหรับ Local Device Console ของ ESP32 ถูกแยกให้คล้าย Dashboard เพื่อให้แก้หน้า เมนู สี และ JavaScript ได้เป็นส่วน ๆ โดยไม่ต้องแก้ไฟล์ HTML/CSS ขนาดใหญ่ไฟล์เดียว
...
HTML ที่ใช้งานบน ESP32 จริงแยกอยู่ที่:
...
`PortalServer.cpp` รับผิดชอบเฉพาะ HTTP routes, validation, NVS และคำสั่งอุปกรณ์ ส่วน HTML อยู่ใน `PortalView` และ Page files เท่านั้น
