...
Write-Host 'dotWatch ILI9341 Smooth Red Dashboard verification' -ForegroundColor Red
Write-Host '============================================================' -ForegroundColor Red
...
$checks = [ordered]@{
    'Firmware smooth UI version' = $firmware -match '1\.1\.6-ili9341-smooth-red-ui'
    ...
    'FreeSans regular font' = $displaySource -match 'FreeSans9pt7b'
    'FreeSans bold label font' = $displaySource -match 'FreeSansBold9pt7b'
    'FreeSans smooth header font' = $displaySource -match 'FreeSansBold18pt7b'
    'FreeSans smooth value font' = $displaySource -match 'FreeSansBold24pt7b'
    'Scaled bitmap font removed' = $displaySource -notmatch 'setTextSize\s*\('
    'Proportional font positioning' = (
        $displaySource -match 'getTextBounds' -and
        $displaySource -match 'drawRightAlignedText'
    )
    'Vector metric icons' = $displaySource -match 'drawMetricIcon'
