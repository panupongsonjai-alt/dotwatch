...
function collectOptions(children, groupLabel = '') {
  return Children.toArray(children).flatMap((child) => {
    if (!isValidElement(child)) return []
    if (child.type === Fragment) {
      return collectOptions(child.props.children, groupLabel)
    }
    if (child.type === 'optgroup') {
      return collectOptions(child.props.children, child.props.label || '')
    }
